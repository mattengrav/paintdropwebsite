...
function introAnimation() {
    ...
    function animate() {
        ...
        if (frames <= 100 && page == 3) {
            ...
            list3.hidden = true;
            list4.hidden = true;
            text.innerHTML = "First, enter a size for the X dimension.  For example, if 3 is given, the canvas will look like this:";
            xTable.hidden = false;
        ...
        if (frames <= 100 && page == 4) {
            ...
            xTable.hidden = true;
            text.innerHTML = "Second, enter a size for the Y dimension.  For example, if 3 is given, the canvas will look like this:";
            yTable.hidden = false;
        ...
        if (frames <= 100 && page == 5) {
            yTable.hidden = true;
            text.innerHTML = "Then choose the colors you want to use from the dropdown menus.  For example, if red, blue, and green are chosen, your graph could look like this: ";
        ...
        if (frames <= 100 && page == 6) {
            ...
            submit.hidden = true;
            colorTable.hidden = true;
            text.innerHTML = "Then you will choose the stopping criteria which determines the conditions that will cause the experiment to stop."
            frames++;
        }
        if (page == 7) {
